            ...
            >
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left ">
                  This project is a{" "}
                  <span className="text-AAsecondary"> SAAS </span> e-commerce
                  project, it helps the store owner to manage their store and
                  products, and also help them to track their orders and
                  customers. It also provides a{" "}
              ...
              <div className="z-10 flex fle-row space-x-5 ">
                <a
                  href="https://admin.resthero.io/"
                  target={"_blank"}
                  rel="noreferrer"
                >
                  <ExternalLink url="https://admin.resthero.io/" />
                </a>
              </div>
            </div>
          </div>
        ...
        >
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            >
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left ">
                  Inspected is a Remote Virtual Inspection software platform
                  designed specifically for inspectors to connect with onsite
                  personnel to help achieve a safe alternative to in-person
                  inspections. Inspected keeps inspections moving forward
                  efficiently creating a dedicated compliance solution in a
                  centralized hub to help promote a safe workplace and focus on
